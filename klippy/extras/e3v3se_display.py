...
class E3v3seDisplay:
    ...
    # color_background_drac = 0x2947  # Black background color
    ...
    color_background_grey = 0x2947  # Dark grey background color
    color_background_drac = 0x2947  # Black background color
    color_background_red = 0x2947  # Red background color
    color_popup_text = 0x2947  # Popup font_ background color
    color_line = 0x2947  # Split line color
    Rectangle_color = 0x2947  # Blue square cursor color
    Percent_color = 0x2947  # Percentage color
    BarFill_color = 0x2947  # Fill color of progress bar
    Selected_color = 0x2947  # Selected color
    ...
    def Draw_Info_Menu(self):
        ...
        self.lcd.draw_icon(False, self.ICON, self.icon_Version, 20, 140)
        self.lcd.draw_string(
            False,
            self.lcd.font_6x12,
            self.color_white,
        ...
        # Contact details
        self.lcd.draw_icon(
            False, self.selected_language, self.icon_TEXT_contact, self.LBLX, 185
        )
        self.lcd.draw_icon(False, self.ICON, self.icon_Contact, 20, 200)
        self.lcd.draw_string(
            False,
            self.lcd.font_8x8,
            self.color_white,
